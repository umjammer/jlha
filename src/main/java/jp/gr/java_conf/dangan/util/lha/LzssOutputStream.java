...
public class LzssOutputStream extends OutputStream {
    ...
    public LzssOutputStream(PostLzssEncoder encoder,
        ...
        try {
            this.method = (LzssSearchMethod) Factory.createInstance(LzssSearchMethodClassName, arguments); //throw ClasNotfoundException, InvocationTargetException, NoSuchMethodException, InstantiationException
